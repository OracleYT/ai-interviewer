...
//         onClick={() =>
//           addProcterEvidance({
//             interviewId: "88af1762a6694713b9d19d670cbe5e05",
//             evidence: { status: "volitile", data: "data", date: new Date() },
//           })
//         }
//       >Add evidance</button>
...
//       {uploadSuccess && (
//         <p>{uploadSuccess.message || "File uploaded successfully!"}</p>
//       )}
...
//           <h3>Uploaded File:</h3>
//           <a
//             href={uploadSuccess.file.location}
//             target="_blank"
